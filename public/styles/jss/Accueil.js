...
formadhe.addEventListener('submit',function(e){
  ...
  }else if(mailadhe.required===true){
    e.preventDefault()
    alert('okkk')
  }else{
    e.preventDefault()
