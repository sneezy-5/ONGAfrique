...
let alertcontact=document.querySelector('.alerte')
let casecnt=document.querySelectorAll('.case')

formcontact.addEventListener('submit', function(e){

  casecnt.forEach(contac=>{

    if(contac.value===""){
      e.preventDefault()
      contac.classList.add('border-danger')
      alertcontact.innerHTML="Veuillez remplir tous les champs"
    }else{
      contac.classList.remove('border-danger')
