...
<head>
  ...
  <title>ONG Sourire d'Afrique Admin </title>
  <!-- plugins:css -->
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="">
            <img src="{{url('styles/img/logo.jpeg')}}" alt="logo" />
          </a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            ...
            <h3 class="welcome-sub-text">Votre résumé des performances cette semaine </h3>
          </li>
        </ul>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Stories</li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('stories.create')}}">Ajouter</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('stories.index')}}">Toutes Les stories</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item nav-category">Don</li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              <i class="menu-icon mdi mdi-card-text-outline"></i>
              <span class="menu-title">Don</span>
              <i class="menu-arrow"></i>
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('newletter.index')}}">
