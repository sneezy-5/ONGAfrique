  ...
  <div class="center row">
    ...
    <div class="card mb-3" style="width: 100rem;margin-top: 100px;">
        <div class="row g-0 ">
          ...
          <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title text-dark h1 titredesc" style="font-weight:700;">@if (app()->getLocale()=="fr") {{$event->title_fr }} @else  {{$event->title_en}} @endif</h5>
               ...
               @if (app()->getLocale()=="fr") {{ $event->description_fr}} @else {{$event->description_en}} @endif
              </p>
